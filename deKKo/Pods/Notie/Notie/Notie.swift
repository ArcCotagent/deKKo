...
public class Notie : UIView {
    ...
    public var leftButtonBackgroundColor = UIColor(hue: 0.2694, saturation: 1, brightness: 0.79, alpha: 1.0)//UIColor(red: 117.0 / 255.0, green: 183.0 / 255.0, blue: 96.0 / 255.0, alpha: 1.0)
    ...
    private func configureButtons() {
        ...
        leftButton.addTarget(self, action: "leftButtonDidTap", for: .touchUpInside)
